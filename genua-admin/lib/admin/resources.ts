...
export const resources: Record<string, ResourceConfig> = {
  ...
  projeler: {
    key: 'projeler', title: 'Projeler', description: 'Portföy projeleri, vaka çalışmaları ve görseller.', table: 'projects', orderBy: 'display_order', createLabel: 'Yeni Proje',
    fields: [
      { name: 'title', label: 'Başlık', type: 'text', required: true }, { name: 'slug', label: 'Slug', type: 'text', required: true },
      { name: 'client_name', label: 'Müşteri', type: 'text' }, { name: 'category', label: 'Kategori', type: 'text' }, { name: 'tags', label: 'Etiketler', type: 'tags', placeholder: 'sosyal medya, reklam' },
      { name: 'cover_image_url', label: 'Kapak Görseli', type: 'image' }, { name: 'gallery_images', label: 'Galeri JSON', type: 'json', full: true },
      { name: 'short_description', label: 'Kısa Açıklama', type: 'textarea', full: true }, { name: 'challenge', label: 'Problem', type: 'textarea', full: true },
      { name: 'strategy', label: 'Strateji', type: 'textarea', full: true }, { name: 'execution', label: 'Uygulama', type: 'textarea', full: true }, { name: 'result', label: 'Sonuç', type: 'textarea', full: true },
      { name: 'metrics', label: 'Metrikler JSON', type: 'json', full: true }, { name: 'tools_used', label: 'Kullanılan Araçlar', type: 'tags' }, { name: 'project_date', label: 'Proje Tarihi', type: 'date' }, { name: 'project_url', label: 'Proje URL', type: 'url' },
      { name: 'display_order', label: 'Sıra', type: 'number' }, { name: 'is_active', label: 'Aktif', type: 'checkbox' }, { name: 'is_featured', label: 'Öne Çıkan', type: 'checkbox' }, ...commonSeo,
