...
export type Database = {
  public: {
    Tables: {
      ...
      team_members: TableDef<{ id: string; full_name: string; title: string; bio: string | null; photo_url: string | null; social_linkedin: string | null; social_instagram: string | null; social_twitter: string | null; email: string | null; display_order: number | null; is_active: boolean | null; created_at: string | null; updated_at: string | null }>;
      ...
      client_logos: TableDef<{ id: string; company_name: string; logo_url: string | null; website_url: string | null; display_order: number | null; is_active: boolean | null; created_at: string | null }>;
