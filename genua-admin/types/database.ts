...
export type Database = {
  public: {
    Tables: {
      ...
      chat_leads: TableDef<{ id: string; full_name: string | null; contact: string | null; email: string | null; phone: string | null; service_interest: string | null; company_size: string | null; message: string | null; conversation_summary: string | null; source: string | null; status: string | null; referrer_page: string | null; user_agent: string | null; created_at: string | null; updated_at: string | null }>;
      ...
      instagram_reels: TableDef<{ id: string; title: string | null; client_name: string | null; reel_url: string; thumbnail_url: string | null; display_order: number | null; is_active: boolean | null; created_at: string | null; updated_at: string | null }>;
      behance_projects: TableDef<{ id: string; title: string | null; client_name: string | null; project_url: string; cover_image_url: string | null; display_order: number | null; is_active: boolean | null; created_at: string | null; updated_at: string | null }>;
      featured_references: TableDef<{ id: string; title: string; slug: string | null; category: string | null; cover_image_url: string | null; logo_url: string | null; short_description: string | null; project_url: string | null; display_order: number | null; is_active: boolean | null; created_at: string | null; updated_at: string | null }>;
